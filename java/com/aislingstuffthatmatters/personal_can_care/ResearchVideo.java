...
public class ResearchVideo extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_research_video);

        et_video = findViewById(R.id.et_video);
    ...
    public void sendToDB(){
        ...
        String videoName = et_video.getText().toString();
        ...
        db.collection("Videos")
                .add(reading)
                .addOnSuccessListener(documentReference -> Toast.makeText(ResearchVideo.this, "Video successfully added!", Toast.LENGTH_SHORT).show())
                .addOnFailureListener(e -> Toast.makeText(ResearchVideo.this, "Error!", Toast.LENGTH_SHORT).show());
    ...
    public void onClick(View v) {
        ...
        switch(v.getId()){
            ...
            case R.id.btn_viewAll:
                startActivity(new Intent(ResearchVideo.this, ResearchVideoShow.class));
                break;
