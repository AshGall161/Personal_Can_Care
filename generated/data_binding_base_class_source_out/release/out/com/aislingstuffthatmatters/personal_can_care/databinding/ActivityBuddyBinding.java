...
public final class ActivityBuddyBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityBuddyBinding(@NonNull RelativeLayout rootView, @NonNull Button btnHome,
  ...
  @NonNull
  public static ActivityBuddyBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityBuddyBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_buddy, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityBuddyBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityBuddyBinding((RelativeLayout) rootView, btnHome, btnSubmit, etEmail,
